                    ...
                    <div class="form-example-wrap mg-t-30">
                        ...
                        <div class="form-example-int mg-t-15">
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                    <a href='ubahProfil.php'><button class='btn btn-primary btn-sm'>Ubah </button></a>
                                    <a href='ubahPassword.php'><button class='btn btn-warning btn-sm'>Ganti Password </button></a>
                                </div>
                            </div>
                        </div>
                    </div>
