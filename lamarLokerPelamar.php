...
<body>
    ...
    $sql = mysqli_query($conn, "SELECT * FROM pelamar WHERE email = '$email'");
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Apakah anda yakin akan melamar ke <?php echo $hasil['nama_perusahaan'] ?> sebagai <?php echo $hasil['posisi'] ?></h2>
                            <?php
                            echo "<td>
                               <a href='prosesLamarPelamar.php?id=$dat[id_pelamar]&&id_loker=$hasil[id_loker]'><button class='btn btn-success btn-sm'> lamar </button></a> <td>";
                               ?>
                            <td><a href='loker.php'><button title='batal' class='btn btn-danger btn-sm '> kembali </button></a></td>
