              ...
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="form-example-wrap mg-t-30">
                    ...
                    <form action="prosesRegistrasiPelamar.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-example-int mg-t-15">
                          <div class="row">
                            <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                             <button class="btn btn-success notika-btn-success" type="daftar" title="simpan">Daftar</button>
                             <button class="btn btn-success btn-danger" title="batal"><a href ="login.php">Batal</a></button>
                           </div>
                         </div>
