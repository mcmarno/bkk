            ...
            <div class="row">
                ...
                <div>
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro pull-right">
                        <li>
                            <a href='login.php'><button class='btn btn-danger btn-sm'>Login </button></a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                echo "<div class='col-md-12'>";
                    echo "<div class='dialog-inner mg-t-30'>";
                        ...
                        echo "<div class='dialog-pro dialog'>";
                            echo "<a data-toggle='modal' data-target='#myModalone' data-id=".$data['id_loker']."><button class='btn btn-info btn-sm'>View </button></a>
                        </div>";
                    echo "</div>";
                echo "</div>";
            echo "</div>";
