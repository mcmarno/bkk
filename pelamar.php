...
<body>
    ...
    $result = mysqli_query($conn, "SELECT * FROM pelamar ORDER BY id_pelamar ASC");
    ?>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Data Pelamar</h2>
                            <a href="tambahPelamar.php"><button class="btn btn-primary btn-icon-notika"><i class="notika-icon notika-plus-symbol" title="tambah"> Tambah Pelamar</i> </button></a>
                        </div>
